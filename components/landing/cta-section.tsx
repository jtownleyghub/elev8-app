  ...
  return (
    <section className="py-20 px-4 md:px-6 bg-gradient-to-br from-indigo-900 to-purple-900">
      <div className="container mx-auto max-w-4xl text-center">
        ...
        <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to make your dreams a reality?</h2>
        <p className="text-xl text-indigo-200 mb-8 max-w-2xl mx-auto">
          Join thousands who are balancing their daily responsibilities while making meaningful progress toward their
          biggest aspirations.
        </p>
